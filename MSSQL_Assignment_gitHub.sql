...
create table OverallProduct (
	...
	brand_address nvarchar(150),
	brand_phone nvarchar(14),
	item_id int,
	item_name nvarchar(50),
	item_description nvarchar(150),
	item_unit nvarchar(14),
	item_price numeric(10,2),
	item_qty int
);
...
--create table phoneRegisterOverall (
--	citizen_id int primary key,
--	citizen_name nvarchar(50),
--	id_number int,
--	citizen_address nvarchar(150),
--	phone_number nvarchar(14),
--	phone_service nvarchar(14),
--	register_date date,
--)
...
create table subscriptions (
	subscript_id int primary key,
	citizen_id int references citizens(citizen_id),
	register_date date,
	subscription_number nvarchar(14),
	subscription_id int references subscriptionTypes(subscription_id)
)
...
create table productsAssignmentOverall (
	item_id nvarchar(50),
	manu_date date,
	item_name Nvarchar(50),
...
create table categories (
	cat_id nvarchar(20) primary key,
)
...
create table items (
	...
	cat_id nvarchar(20) references categories(cat_id)
)

create database MSSQL_Assignment_05
use MSSQL_Assignment_05
--a composite key from person_id and phone
...
create table phoneNumbers (
	...
	phone nvarchar(14) primary key,
	person_id int references contactPersons(person_id)
)
